;(function(root, factory) {
  ...
  PdfViewer.prototype.embed = function(container) {
    ...
    var html = [
      ...
      '<link rel="stylesheet" href="'+ this.host + '/src/styles/viewer.css"/>',
      '<link rel="resource" type="application/l10n" href="' + this.host + '/src/locale/locale.properties"/>',
      '<script src="'+ this.host + '/lib/pdf.js"></script>',
      '<script src="' + this.host + '/src/viewer.js"></script>',
